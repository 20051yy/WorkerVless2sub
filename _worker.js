...
// 设置优选地址api接口
let addressesapi = [  
	'https://a014a32b.cf-workers-text2kv-6c1.pages.dev/ip.txt', //可参考内容格式 自行搭建。          
...
let DLS = 6;//速度下限
let addressescsv = [      
	//'https://a014a32b.cf-workers-text2kv-6c1.pages.dev/result.csv?token=20051126&t=1729787579734', //iptest测速结果文件。        
];
